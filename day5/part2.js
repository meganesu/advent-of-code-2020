...
for (let i = seatIdArray.length - 1; i > 0; i--) {
	// compare the current id to the one before it
	// if they're two values apart, then the 
	if (seatIdArray[i] === seatIdArray[i-1] + 2) {
		console.log('My seat id:', seatIdArray[i] - 1)
		break
	}
}